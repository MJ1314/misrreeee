...
import { Contact, Agency, Ticket } from '@prisma/client'
...
const ContactPage = async ({ params }: Props) => {
  type AgencyWithContacts = Agency & {
    Contact: (Contact & { Ticket: Ticket[] })[]
  }

  const contacts = (await db.agency.findUnique({
    where: {
      id: params.agencyId,
    },
    include: {
  ...
  return (
    <BlurPage>
      ...
      <CraeteContactButton agencyId={params.agencyId} />
      <Table>
        <TableHeader>
          <TableRow>
